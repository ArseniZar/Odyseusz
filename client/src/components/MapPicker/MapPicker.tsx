...
export const MapPicker = ({
  ...
  return (
    <div className={`relative flex flex-col gap-2 group ${className}`}>
      ...
      {tooltipText && (
        <div className="z-50 absolute bottom-full mb-1 py-2 px-3 rounded-2xl border border-black/10 bg-white opacity-0 shadow-xl invisible group-hover:visible group-hover:opacity-100 transition-opacity duration-400">
      ...
      <div
        ref={mapRef}
        className={`${
          fullscreen ? "fixed inset-0 z-50 bg-white" : "relative h-[300px] rounded-2xl border border-black/10"
        }`}
      >
        <button
