...
export const AssistantInformation = ({assistantNumber,infoText,email,name, phone,workingHours}: AssistantInformationProps): JSX.Element => {
  return (
    <div className="flex flex-row gap-5 border-b pb-3">
      <p className="font-medium text-xl w-1/6">{infoText.title} {assistantNumber}</p>
